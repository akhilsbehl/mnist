...
cmd:option('--printstep', 50, 'Print output every step batches.')
cmd:option('--quieter', false, 'Suppress logging batches to stdout?')
...
cmd:option('--earlystop', 4, 'Number of unimproved epochs to stop after.')
cmd:option('--maxepochs', 64, 'Maximum number of epochs to run training for.')
